---
title: "An Analysis of the Metrics Used in the 2025 Budget Reduction Proposal"
...
::: callout
### Problem: Calculating the Share of Growth

This is another variable which is likely Cauchy distributed (see @sec-probs-cauchy), that is, it is the statistical equivalent of dividing by zero - the mean of the numerator is likely to be zero (in distribution) and the mean of the denominator is likely to be zero (in distribution) -- each year's SCH would be expected to be sampled from the same distribution at the department and university level. 
...
### Problems with `research_awards_growth_inc_nuf_fy20_fy24` {#sec-probs-cauchy}

Of all of the random variables created in this analysis, the most problematic from a statistical theory perspective might be `research_awards_growth_inc_nuf_fy20_fy24`.
