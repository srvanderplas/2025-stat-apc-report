...
stats_full_dot <- stats_full |>
  ...
  left_join(colors) |>
  mutate(color = if_else(institutionname != "University of Nebraska - Lincoln", "grey", color)) |>
...
stats_full_dot |>
  ...
  geom_text(
    ...
    data = filter(stats_full_dot, shortname=="UNL", color != "grey"))
