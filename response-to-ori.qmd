...
#| fig-height: 7.75
#| fig-width: 7
#| fig-cap: Dot plot of the importance of a unit/discipline for AAU compared to all universities. In color all disciplines with units at UNL affected by the budget cut. Several departments with highly important disciplines for AAU are slated for elimination.
