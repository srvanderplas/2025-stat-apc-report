...
- 1993 - The Mathematics APR Report recommends creation of a separate department of statistics ([2001 Mathematics & Statistics APR Self-Study](https://www.math.unl.edu/~dpitts2/APR/apr.pdf), pg 147)
...
- 2013 - [APR Team recommends](2013-STAT-APR-Report.pdf) reducing graduate program enrollment, creation of an undergraduate and 3+2 BS+MS program. 
...
- 2021 - [APR team recommends](2021-STAT-APR-Report.pdf) increase in number of tenure-track faculty and departmental administration to ensure program success.
...
We exclude from this "big tent" biostatistics departments, not because they don't serve a similar role, but because many universities have both Statistics and Biostatistics departments^[The statistics department is typically on the main campus and the biostatistics department is typically located within the medical school organizational structure.], so we have tracked Biostatistics separately. 
Note that this differs from the Academic Analytics tracking of Statistics as a discipline, but the conclusions of this analysis are largely the same whether using their methods or ours. 
