...
The Biostatistics department at UNMC lists several areas of statistics research within the department: Bayesian statistics, clinical study design, causal inference, high dimensional data and machine learning, survival data analysis, spatial statistics, statistics education, bioinformatics and statistical genetics, stochastic modeling.
Fourteen of the sixteen tenured or tenure-track faculty members at UNMC received their Ph.D. from a Statistics department^[Dr. Christopher Wichman, received his Ph.D. in Biostatistics from UNMC, and Dr. Jerrod Anzalone received his Ph.D. in Biomedical Informatics from UNMC.], and five of the sixteen received their Ph.D. from the Statistics department at UNL (see @tbl-unmc-biostats for a full list). 
While Biostatisticians at UNMC do valuable work that contributes to research methodology in Statistics, many of the listed papers were published before the faculty member joined UNMC - that is, the broader methodological papers were written as part of their doctoral work in Statistics!
...
@sec-peer-analysis includes an analysis of peer R1 and AAU institutions, many of whom maintain both statistics and biostatistics departments. 

Finally, there is a Mathematics department at UNO which offers statistics coursework and a data science program. 
...
A statistics department provides a number of services within the campus ecosystem apart from its own programs (which often exist in part to facilitate providing these services efficiently, as demonstrated in the 1993 Biometry Self-Study report). 
...
At the graduate level, the department provides additional critical training, not just in statistical methods (Stat 801, 802) but also in computing and the use of software packages for data analysis and visualization (Stat 850). 
These courses facilitate research across the university, in a way that is difficult to 
There is considerable potential for growth in enrollment in Stat 850 in particular: it already consists of approximately 50% statistics students and 50% outside students, and it is helpful for students in agronomy, biological sciences, engineering, psychology, and sociology. 
In addition to introductory courses, however, graduate students in other departments may need additional course work in experimental design and specific areas of statistical methodology, such as Bayesian statistics. 
...
While it may be necessary to offer two courses to accommodate lack of linear algebra or calculus prerequisite work in some disciplines, nthis is still a substantial savings over offering five separate courses. 
