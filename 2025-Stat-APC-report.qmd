...
That is, if the Statistics department is eliminated, it is likely to hurt UNL's case to be readmitted to the AAU, even though our SRI is below the mean for AAU institutions. 
Instead, what is clear is that the Statistics department is performing within the range expected of statistics departments at AAU institutions.  
...
It is also possible that the average course size may have decreased in the department over the last 3-4 years due to the large increase in new courses along with relatively small initial cohorts as the major started but before we could advertise the job and graduate school placements of our graduates (we will have a couple of students graduating early in December and the rest of the first cohort graduating in May).
